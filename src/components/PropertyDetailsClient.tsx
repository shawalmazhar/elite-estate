...
import {
  BedDouble, Bath, Maximize, Calendar,
  ShieldAlert, Sparkles, MapPin, CheckCircle, ChevronLeft
} from "lucide-react";
...
export default function PropertyDetailsClient({ property }: { property: Property }) {
  ...
  const renderHotspots = () => {
    if (property.id !== "the-sky-penthouse") return null;
    ...
    <div className="w-full bg-matte-black min-h-screen pt-32 pb-24 text-off-white relative">
      <div className="max-w-7xl mx-auto px-6 md:px-12">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start mb-24">
          {/* Left Column: Premium HD Showcase Carousel */}
            ...
            <form onSubmit={handleBookingSubmit} className="space-y-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 font-sans text-xs pt-4">
                ...
                <div className="space-y-2">
                  ...
                  >
                    <option value="" disabled className="text-off-white/40">Select liquidity threshold</option>
              ...
              <div className="pt-4 flex justify-center">
                <button
                  type="submit"
                  disabled={submitting}
                  className="relative px-10 py-4 font-sans text-xs font-bold uppercase tracking-[0.25em] text-matte-black bg-elite-gold hover:bg-white transition-all duration-500 rounded-sm flex items-center gap-3 disabled:opacity-50"
                >
                  {submitting ? (
                    <>
